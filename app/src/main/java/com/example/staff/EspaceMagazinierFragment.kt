 ...
 * Use the [EspaceMagazinierFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EspaceMagazinierFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_espace_magazinier, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment EspaceMagazinierFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EspaceMagazinierFragment().apply {
